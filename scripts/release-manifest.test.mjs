...
const input = {
  ...
  deployment: { provider: "github-actions", repositoryId: "1345904214", runId: "12345", runAttempt: 2, ref: "refs/heads/production" },
...
test("artifact path, digest, and deployment scope are bound", () => {
  ...
  assert.throws(() => createReleaseManifest({ ...input, deployment: { ...input.deployment, ref: "refs/heads/feature" } }), /refs\/heads\/production/u);
});
