...
assert.match(observability, /ExistingProjectCostAnomalyMonitorArn:[\s\S]*anomalymonitor/u);
assert.match(observability, /CreateProjectCostAnomalyMonitor: !Equals \[!Ref ExistingProjectCostAnomalyMonitorArn, ""\]/u);
assert.match(observability, /ProjectCostAnomalyMonitor:[\s\S]*Condition: CreateProjectCostAnomalyMonitor[\s\S]*MonitorSpecification: '\{"Tags":\{"Key":"user:Project","Values":\["eacl-demo"\]\}\}'[\s\S]*MonitorType: CUSTOM/u);
assert.match(observability, /MonitorArnList:[\s\S]*CreateProjectCostAnomalyMonitor[\s\S]*!Ref ProjectCostAnomalyMonitor[\s\S]*!Ref ExistingProjectCostAnomalyMonitorArn/u);
