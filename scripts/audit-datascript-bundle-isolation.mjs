...
for (const marker of ["dev.eacl/eacl-datascript", "cljs.core", "858a73a62dfcdf05a5341787f806796d55fd2aff"]) {
...
const evidence = {
  ...
  dedicatedRuntime: {
    ...
    witnesses: ["dev.eacl/eacl-datascript", "cljs.core", "858a73a62dfcdf05a5341787f806796d55fd2aff"]
  }
};
