...
for (const marker of ["dev.eacl/eacl-datascript", "cljs.core", "990a58162a0a03c365db46cf166c5966ab70950a"]) {
...
const evidence = {
  ...
  dedicatedRuntime: {
    ...
    witnesses: ["dev.eacl/eacl-datascript", "cljs.core", "990a58162a0a03c365db46cf166c5966ab70950a"]
  }
};
