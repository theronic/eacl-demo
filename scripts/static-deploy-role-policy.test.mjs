...
test("static deployment trust is the exact inactive-until-eligible ordinary authority", () => {
  ...
  assert.match(source, /token\.actions\.githubusercontent\.com:sub: repo:theronic@1011676\/eacl-demo@1345904214:ref:refs\/heads\/production:workflow_ref:theronic\/eacl-demo\/\.github\/workflows\/deploy-demos\.yml@refs\/heads\/production:environment:demo-production-static:event_name:push:runner_environment:github-hosted/u);
