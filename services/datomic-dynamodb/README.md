...
protocol, endpoint, credentials, or query parameters. Each request receives a
direct EACL snapshot over the same retained DB value. Only absent, `current`,
and `minimize` consistency inputs pass the public boundary. Its wire basis
