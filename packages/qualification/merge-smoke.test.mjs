...
const target = { kind: "staged-cloudfront", origin: "https://staging.demo.eacl.dev", path: "/", profileId: identity.profileId };
...
test("merge smoke is exactly health, identity, allow, deny, and mutation denial", async () => {
  ...
  assert.deepEqual(operations, ["health", "bootstrap", "check-permission", "check-permission", "seed"]);
