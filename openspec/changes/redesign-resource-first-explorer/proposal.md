...
- Give the shared demos a coherent light/dark visual system, always-visible backend/storage/execution choices and a prominent four-mode consistency panel. Retain the 🦅 eagle logo and use larger readable typography, especially for resource identifiers and timing evidence.
